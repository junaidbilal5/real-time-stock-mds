...
SNOWFLAKE_USER = "JUNAIDBILAL005"
SNOWFLAKE_PASSWORD = "A!rfl0w$2026#SNF"
SNOWFLAKE_ACCOUNT = "hp79163.eu-central-1"
SNOWFLAKE_WAREHOUSE = "SNOWFLAKE_LEARNING_WH"
SNOWFLAKE_DB = "STOCKDATA"
...
def load_to_snowflake(**kwargs):
    ...
    for f in local_files:
        cur.execute(f"PUT file://{f} @%BRONZE_DATA")
        print(f"Uploaded {f} to Snowflake stage")

    cur.execute("""
        COPY INTO BRONZE_DATA
        FROM @%BRONZE_DATA
